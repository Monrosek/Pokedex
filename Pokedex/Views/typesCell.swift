...
class typesCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        // Initialization code
        self.collectionView.register(typeCollectionCell.nib, forCellWithReuseIdentifier: typeCollectionCell.identifier)
...
extension CollectionViewCell: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "typeCollectionCell", for: indexPath) as? typeCollectionCell {
